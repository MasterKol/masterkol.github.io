...
var App = /** @class */ (function () {
    function App() {
        ...
        this.loadVariants = function () {
            ...
            console.log("x");
            console.log(_this.fontList.items[_this.selectFamily.selectedIndex]);
    ...
    App.prototype.handleEvents = function () {
        // console.log(this.selectFamily.onchange);
    ...
    App.prototype.callMakerjs = function (font, text, size, union, kerning, separate, bezierAccuracy) {
        ...
        //     }
        // }
        // var textModel = new makerjs.models.Text(font, text, size, union, false);
        /*if (separate) {
            for (var i in textModel.models) {
                textModel.models[i].layer = i;
            }
    ...
    App.prototype.render = function (fontIndex, variantIndex, text, size, union, kerning, separate, bezierAccuracy) {
        ...
        console.log(f)
        console.log(v)
        console.log(f.variants)
        console.log(f.files[v])
        ...
        opentype.load(url, function (err, font) {
            if (err) {
                ...
                _this.callMakerjs(font, text, size, union, false, kerning, separate, bezierAccuracy);
            }
        });
    };
    return App;
